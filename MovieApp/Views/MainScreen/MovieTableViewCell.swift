...
//  MovieApp
//
//  Created by Дайняк Александр Николаевич on 09.03.2021.
//
...
//        movieView.addSubview(descriptionLabel)
...
//        descriptionLabel.topAnchor.constraint(equalTo: dateLabel.bottomAnchor).isActive = true
//        descriptionLabel.leadingAnchor.constraint(equalTo: movieImage.trailingAnchor, constant: Consts.spacing)
//            .isActive = true
//        descriptionLabel.trailingAnchor.constraint(equalTo: movieView.trailingAnchor, constant: -Consts.spacing)
//            .isActive = true
//        descriptionLabel.heightAnchor.constraint(equalToConstant: Consts.descriptionHeight).isActive = true
